(function () {
    ...
    .controller("TestDateTimePicker", TestDateTimePicker)
    TestDateTimePicker.$inject = ['$scope'];
    function TestDateTimePicker($scope) {
    ...
    $scope.openCalendar = function (e, picker) {
        //if($scope.picker1.date==null)
        //    $scope.picker1.date=new Date();
        console.log("that[picker].open value is ", that[picker].open + 'data is ' + $scope.picker1.date);
